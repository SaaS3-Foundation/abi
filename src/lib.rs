...
//!
//! Parameters from contract are consumed as `Vec<U256>`, which avoids reading
...
/// SaaS3 protocol ABI object that can be encoded into the vector of U256 and decoded from it
#[derive(Debug, PartialEq, Clone)]
pub struct ABI {
...
impl ABI {
    /// constructor of ABI from the list of parameters
    ...
    /// constructor of ABI with no parameters
    pub fn none() -> Self {
        Self {
            version: 0x31,
            schema: "1".to_owned(),
    ...
    /// constructor of ABI with a single parameter
